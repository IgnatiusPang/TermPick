---
title: "Process the peak pick results"
output: html_notebook
---

Script to run after pick_peak_step.Rmd
...
knitr::purl( file.path( source_dir, "Call_peaks_v2",  "process_peak_pick.Rmd"), 
output=file.path(source_dir, "Call_peaks_v2",  "process_peak_pick.R") ) 

nohup Rscript --vanilla  process_peak_pick.R > run_process_peak_pick_${DATE}.log 2>&1 &
